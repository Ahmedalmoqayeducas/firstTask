                                            ...
                                            <tr class="even" id="element_{{ $element->id }}">
                                                ...
                                                <td class="table-td ">
                                                    <div class="flex space-x-3 rtl:space-x-reverse">
                                                        <!-- زر Show -->
                                                        <a href="{{ route('posts.show', $element->id) }}" class="action-btn btn-primary ">
                                                            <iconify-icon icon="heroicons:eye"></iconify-icon> <!-- أيقونة العرض -->
                                                        </a>

                                                        <!-- زر Edit -->
                                                        <a class="action-btn btn-warning" href="{{ route('posts.edit', $element->id) }}">
                                                            <iconify-icon icon="heroicons:pencil-square"></iconify-icon> <!-- أيقونة التعديل -->
                                                        </a>

                                                        <!-- زر Delete -->
                                                        <button type="button" onclick="destroy({{ $element->id }})" class="action-btn btn-danger">
                                                            <iconify-icon icon="heroicons:trash"></iconify-icon> <!-- أيقونة الحذف -->
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
