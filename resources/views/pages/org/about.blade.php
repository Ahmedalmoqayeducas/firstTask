...
@section('content')
    ...
    <section class="about" data-aos="fade-up">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <img src="{{ asset('org/img/about.jpg') }}" class="img-fluid" alt="">
                </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonials-carousel">
                ...
                <div class="testimonial-item">
                    <img src="{{ asset('org/img/testimonials/testimonials-1.jpg') }}" class="testimonial-img"
                        alt="">
                    <h3>Saul Goodman</h3>
                    <h4>Ceo &amp; Founder</h4>
                    <p>
                ...
                <div class="testimonial-item">
                    <img src="{{ asset('org/img/testimonials/testimonials-2.jpg') }}" class="testimonial-img"
                        alt="">
                    <h3>Sara Wilsson</h3>
                    <h4>Designer</h4>
                    <p>
